//onclick event function call to get input value.
document.querySelector('#btn_sum').addEventListener('click', () =>{
    ...
    // four input value[5% per] calculation
    ...
    // five input value[5% per] calculation
    ...
    // six input value[5% per] calculation
    ...
    // seven input value[5% per] calculation
    ...
    // eight input value[5% per] calculation
